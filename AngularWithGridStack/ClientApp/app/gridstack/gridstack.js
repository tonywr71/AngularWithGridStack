...
(function (GridStack_1) {
    ...
    */
    ...
    var Utils = (function () {
        ...
        Utils.sort = function (nodes, dir, width) {
            width = width || _.chain(nodes).map(function (node) { return node.x + node.width; }).max().value();
            dir = dir != -1 ? 1 : -1;
            return _.sortBy(nodes, function (n) { return dir * (n.x + n.y * width); });
        };
        Utils.createStylesheet = function (id) {
        ...
        Utils.insertCSSRule = function (sheet, selector, rules, index) {
        ...
        Utils._collisionNodeCheck = function (n) {
            return n != this.node && Utils.isIntercepted(n, this.nn);
        };
        Utils._didCollide = function (bn) {
            return Utils.isIntercepted({ x: this.n.x, y: this.newY, width: this.n.width, height: this.n.height }, bn);
        };
        Utils._isAddNodeIntercepted = function (n) {
    ...
    */
    var GridStackDragDropPlugin = (function () {
        function GridStackDragDropPlugin() {
        }
        ...
        return GridStackDragDropPlugin;
    }());
    var idSeq = 0;
    var GridStackEngine = (function () {
        function GridStackEngine(width, onchange, floatMode, height, items) {
            this.width = width;
        ...
        GridStackEngine.prototype.canMoveNode = function (node, x, y, width, height) {
            ...
            var clonedNode;
            var clone = new GridStackEngine(this.width, null, this.float, 0, _.map(this.nodes, function (n) {
                if (n == node) {
                    clonedNode = $.extend({}, n);
                    return clonedNode;
                }
            ...
            var res = true;
            if (hasLocked) {
                res = res && !Boolean(_.find(clone.nodes, function (n) {
        ...
        GridStackEngine.prototype.canBePlacedWithRespectToHeight = function (node) {
            ...
            var clone = new GridStackEngine(this.width, null, this.float, 0, _.map(this.nodes, function (n) { return $.extend({}, n); }));
    ...
    var GridStack = (function () {
        function GridStack(el, opts) {
            ...
            this.placeholder = $('<div class="' + this.opts.placeholderClass + ' ' + this.opts.itemClass + '">' +
                '<div class="placeholder-content">' + this.opts.placeholderText + '</div></div>').hide();
            this._updateContainerHeight();
            this._updateHeightsOnResize = _.throttle(function () {
                self.cellHeight(self.cellWidth(), false);
            }, 100);
            this.onResizeHandler = this.onResizeHandlerFunction(self, isAutoCellHeight, oneColumnMode);
        ...
        GridStack.prototype.onResizeHandlerFunction = function (self, isAutoCellHeight, oneColumnMode) {
            return function () {
                if (isAutoCellHeight) {
        ...
        ;
        GridStack.prototype.getHeightFunction = function (self) {
        ...
        ;
        GridStack.prototype.onStartMoving = function (self, node, el) {
        ...
        GridStack.prototype.onEndMoving = function (self, node, el) {
            return function (event, ui) {
                var o = $(this);
        ...
        GridStack.prototype.dragOrResize = function (self, node, el) {
            return function (event, ui) {
                var cellWidth = self.cellWidth();
        ...
        //}
        GridStack.registerPlugin = function (pluginClass) {
            GridStack.registeredPlugins.push(pluginClass);
        };
        return GridStack;
    }());
    GridStack.registeredPlugins = [];
    var JQueryUIGridStackDragDropPlugin = (function () {
        function JQueryUIGridStackDragDropPlugin() {
        }
    ...
    scope.GridStackUI.registerPlugin(new JQueryUIGridStackDragDropPlugin());
